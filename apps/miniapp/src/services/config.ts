...
export const BANNER_AD_UNIT_ID = import.meta.env.VITE_BANNER_AD_UNIT_ID || "";
export const INTERSTITIAL_AD_UNIT_ID = import.meta.env.VITE_INTERSTITIAL_AD_UNIT_ID || "";
